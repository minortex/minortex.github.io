...
这一种字体是专为代码显示设计的，因为缩进的时候能够更好的对齐，在终端中，也能让 Tab 更好的对齐；而且易于分辨`I l`以及`O 0`。
...
对于英文字体来说，有一套字体叫做`liberation`，全面实现了对 Windows 上面的常见字体的兼容，这套字体是红帽开发的。
...
管理字体，现代的 Linux 系统基本都是 fontconfig 了。我们主要是用`fc-cache`,`fc-match`两个命令。
